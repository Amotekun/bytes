...
export const Thumbnail: React.FC<ThumbnailProps> = ({
    ...
    return (
        <div className="group aspect-video relative rounded-md cursor-pointer">
            <div className="rounded-md absolute inset-0 bg-blue-600 group-hover:opacity-100 transition-opacity flex items-center justify-center opacity-0">
                {content}
                {isLive && src && (
...
/* TODO: ADD A THUMBNAIL SKELETON HERE */